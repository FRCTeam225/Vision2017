...
/*
 * BetterCamera2Renderer
 *
 * Developed by Team 254, The Cheesy Poofs
 * Original source at https://github.com/Team254/FRC-2016-Public/tree/master/vision_app/app/src/main/java/org/opencv/android
 */
    ...
    protected void openCamera(int id) {
        ...
        try {
            ...
            if (mCameraID != null) {
                ...
                mView.setVerticalFOV(2.0 * Math.toDegrees(Math.atan(0.5 * height_dim / focal_lengths[0])));
